...
## スクリーンショット
###パソコンが建てた部屋に、別のデバイスから参加する場合
![初期ホーム画面（パソコン） — プレイヤー名・部屋IDの入力フォームが表示されている](images/home.png)
![ロビー画面（パソコン） — 部屋番号・参加者一覧・ゲーム設定パラメータが表示されている](images/lobby.png)
![初期ホーム画面（スマホ） — パソコンが建てた部屋番号と同じ番号を入力する](images/home2.png)
パソコン画面にスマホの表示
準備OKをパソコンが押す
スマホも押すと承認画面が出現
パソコンが承認
...
そのまま、スマホははやから抜けてパソコンは別部屋でプレイ
ゲーム開始後にスマホがパソコン後プレイ中の部屋で遊ぼうとすると、ブロックされる
結果はパソコンのみ変動するが、スマホの結果も表示され続ける
