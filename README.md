...
**【PC】初期ホーム画面に、プレイヤー名・部屋IDの入力フォームが表示されている**<br>
<img src="images/home.png" width="650" alt="PCのホーム画面">
**【PC】部屋を作成すると自動でロビー画面へ移動し、部屋番号・参加者一覧・ゲーム設定パラメータが表示されている**<br>
<img src="images/lobby.png" width="650" alt="PCのロビー画面">
**【スマホ】初期ホーム画面にて、PCが建てた部屋番号と同じ番号を入力し参加する**<br>
<img src="images/roomnumber.jpg" width="250" alt="スマホのホーム画面から参加">
**【PC】PCのロビー画面にスマホからのユーザー名が追加される**<br>
<img src="images/lobby2.png" width="650" alt="PCのロビーにスマホユーザーが追加">
**【PC】PCのロビー画面にて、「準備完了」ボタンを押す**<br>
<img src="images/OK.png" width="650" alt="PCで準備完了">
**【スマホ】スマホのロビー画面からも、「準備完了」ボタンを押す。同時に、今回は参加人数を5人に設定し、2人しか参加者がいないため、Botを3人加えることに関する承認画面が出現する**<br>
<img src="images/NPC.png" width="250" alt="スマホでのBot追加承認画面">
**【PC】PC画面でBot追加を承認すると同時に、承認画面には現在の承認人数が示される**<br>
<img src="images/NPC2.png" width="650" alt="PCでのBot追加承認と人数の反映">
**【スマホ】スマホも承認するとゲームフィールドに移動する。フィールドにトラップ・障害物・複数プレイヤーが表示されている**<br>
<img src="images/Game.png" width="250" alt="スマホのゲームフィールド画面">
**【スマホ】スマホでもフィールド全体がしっかり見える**<br>
<img src="images/Game_from_smartphone.jpg" width="250" alt="スマホからのフィールド全体ビュー">
**【PC】制限時間後に、勝敗・ポイント変動がランキング形式で表示されている**<br>
<img src="images/result.png" width="650" alt="PCのリザルト画面">
**【PC】ホーム画面に結果表が追加される**<br>
<img src="images/home_with_results.png" width="650" alt="PCのホーム画面（結果追加後）">
<br>

### ユーザー1が新しく部屋を作成し、1人でプレイを始めた場合
**【PC】スマホは部屋から抜けて、パソコンは別部屋を作成する**<br>
<img src="images/lobby_one.png" width="650" alt="PCで別部屋を作成">
**【PC】準備完了を押すとBot参加の承認画面が出てくる。今回は参加人数を5人に設定し、参加者は1人であるため、Botを4人加えることに関する承認画面が出現する**<br>
<img src="images/OK_one.png" width="650" alt="PCで1人プレイ時のBot承認">
**【スマホ】スマホ上に、ユーザー1がプレイ中の部屋番号を入力する**<br>
<img src="images/roomnumber_block.png" width="250" alt="スマホからプレイ中の部屋番号を入力">
**【スマホ】部屋に入ろうとすると、警告が出て参加をブロックされる**<br>
<img src="images/block.jpg" width="250" alt="スマホでの参加ブロック警告">
**【PC】結果はPCのみ更新され、スマホの結果も表示され続ける**<br>
